...
[WARNING]
====
Using Nx and the Nx plugin _@jnxplus/nx-boot-maven_ for a monorepo with a Maven multi-module project doesn't feel right, and I'm close to get rid of Nx.
